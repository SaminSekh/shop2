                ...
                <div class="payment-method-card">
                    ...
                    <div class="qr-code-display" style="margin-bottom: 20px; text-align: center;">
                        <img src="${qrUrl}" alt="Payment QR Code" 
                             style="max-width: 220px; width: 100%; height: auto; border-radius: 8px; border: 1px solid #e2e8f0; display: inline-block;"
                             onerror="this.parentElement.style.display='none'; console.error('Failed to load QR image');">
                        <p style="margin-top: 10px; color: #64748b; font-size: 0.85rem;">Scan with any UPI app</p>
                    </div>` : ''}
        ...
        if (details.usdt_address) {
            ...
            <div class="payment-method-card">
                ...
                <div class="qr-code-display" style="margin-top: 15px;">
                    <img src="${details.usdt_qr_code_url}" alt="Crypto QR Code" style="max-width: 150px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <p style="margin-top: 5px; color: #64748b; font-size: 0.8rem;">Scan to pay</p>
                </div>` : ''}
            </div>`;
        }
